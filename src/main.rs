...
async fn main() {
    ...
    let matches = Command::new("oxigration")
            ...
            Command::new("init")
                ...
                .arg(
                    Arg::new("connection")
                        .short('c')
                        .long("connection")
                        .default_value("postgresql://postgres@0.0.0.0.0/postgres")
                        .help("Database connection string"),
                ),
        )
        .subcommand(
            Command::new("generate")
                .about("Generate DBMS objects source code from the DBMS")
                .arg(
                    Arg::new("dir")
                        .short('d')
                        .long("dir")
        ...
        .subcommand(
            Command::new("migrate")
                .about("Migrate the DBMS by applying SQL changes accurately")
                .arg(
                    Arg::new("dir")
                        .short('d')
                        .long("dir")
...
mod tests {
    ...
    #[test]
    fn test_cli_init() {
        let cmd = Command::new("oxigration")
            .subcommand_required(true)
            .arg_required_else_help(true)
            .subcommand(
